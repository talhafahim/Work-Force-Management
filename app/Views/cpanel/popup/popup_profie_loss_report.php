...
<div id="popup_profit_loss_report" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="myModalLabel">Profit & Loss Report</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="profitlossReportForm" method="POST" target="_blank" action="<?= base_url();?>/report/profit_loss_report" class="form-horizontal form-label-left input_mask">

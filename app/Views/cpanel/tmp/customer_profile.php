		...
		<div class="profile__wrapper">
			...
			<div class="profile__title">
				<div class="profile_image">
					<form>
						<img src="/assets/images/bo-avatar.png" id="pic" style="border: 5px solid #2e3235;">
						<input type="file" id="myfile" style="display:none"/>
					</form>
				</div>
				<div class="profile_name">
					<h2><?= ucfirst($info->firstname).' '.ucfirst($info->lastname);?></h2>
					<p><?= ucwords($info->status);?></p>
				</div>
			</div>
								...
								<div class="card-body">
									...
									<form id="updateProfile">
										...
										<div class="form-group mb-4">
											...
											<div>
												<div class="input-group">
													<input type="text" class="form-control" name="mobile" placeholder="03009999999" value="<?= $info->mobilephone;?>" readonly>
												</div><!-- input-group -->
											</div>
										</div>
										...
										<div class="form-group mb-4">
											...
											<div>
												<div class="input-group">
													<input type="text" class="form-control" name="address" placeholder="" value="<?= $info->address;?>" readonly>
												</div><!-- input-group -->
											</div>
										</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#changePassword").submit(function() {
			$.ajax({
				type: "POST",
				url: '<?php echo base_url();?>/customer/change_password',

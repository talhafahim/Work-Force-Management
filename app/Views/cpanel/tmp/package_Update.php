		...
		<div class="container-fluid">
			<div class="page-title-box">
				<div class="row align-items-center">
					<div class="col-sm-6">
						<h4 class="page-title">Package <small>Update</small></h4>
					</div>
                    <!-- <div class="col-sm-6">
                            ...
                            <div class="card-body">    
                                <form oldid="custAddForm" id="form-horizontal" class="form-horizontal form-wizard-wrapper">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="form-group"> 
                                                        ...
                                                        <select class="form-control select2 city" name="city" required readonly>
                                                            <option value="">Select City</option>
                                                            <?php foreach($cities->get()->getResult() as $value){?>
                                                                <option value="<?= $value->city;?>"  <?= ($value->city == $pkg->city) ? 'selected' : ''; ?> ><?= $value->city;?></option>
                                                            <?php } ?>
                                                        </select>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group"> 
                                                        ...
                                                        <input name="pkgname" type="text" class="form-control" required value="<?= $pkg->name;?>" readonly> 
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group"> 
                                                        <label>Bandwidth (Mbps)<span class="red">*</span></label>
                                                        <input name="bandwidth" type="number" class="form-control" required value="<?= $pkg->bandwidth;?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group"> 
                                                        <label>Package Groupname<span class="red">*</span></label>
                                                        <input name="groupname" type="text" class="form-control" required value="<?= $pkg->groupname;?>"> 
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <div class="form-group"> 
                                                                ...
                                                                <input name="int-rate" id="int-rate" cat="int" type="number" class="form-control calculate" min="0" step="0.1" required value="<?= $pkg->int_rate;?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <div class="form-group"> 
                                                        ...
                                                        <div class="col-sm-2">
                                                            <h5><center id="int-sum">0</center></h5>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <div class="form-group"> 
                                                                ...
                                                                <input name="tv-rate" id="tv-rate" cat="tv" type="number" class="form-control calculate" min="0" step="0.1" required value="<?= $pkg->tv_rate;?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <div class="form-group"> 
                                                        ...
                                                        <div class="col-sm-2">
                                                            <h5><center id="tv-sum">0</center></h5>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <div class="form-group"> 
                                                                ...
                                                                <input name="ph-rate" id="ph-rate" cat="ph" type="number" class="form-control calculate" min="0" step="0.1" required value="<?= $pkg->phone_rate;?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <div class="form-group"> 
                                                        ...
                                                        <div class="col-sm-2">
                                                            <h5><center id="ph-sum">0</center></h5>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                <label class="control-label">Package Disable</label><br>
                                                                <input type="hidden" name="disable" value="enable"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <input type="checkbox" name="disable" id="panel" switch="danger" value="disable" <?= ($pkg->status == 'disable') ? 'checked' : '';?> />
                                        ...
                                        <button type="submit" class="btn btn-success mr-1 waves-effect waves-light pull-right" style="float:left;">Update Package  </button>
                                    </div>
                                </div>  
                            </form>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#form-horizontal").submit(function() {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url();?>/package/update_action',
...
<script>
    ...
    $(document).ready(function(){
        var city = '<?php echo $pkg->city;?>'; 
        apply_tax(city);

    });

    function apply_tax(city){
        $.ajax({
            dataType: "json",
            type: "POST",

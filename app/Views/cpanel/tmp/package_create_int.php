		...
		<div class="container-fluid">
			<div class="page-title-box">
				<div class="row align-items-center">
					<div class="col-sm-6">
						<h4 class="page-title">Package <small>Create (Internet)</small></h4>
					</div>
                    <!-- <div class="col-sm-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group"> 
                                                        ...
                                                        <input name="bandwidth" type="number" class="form-control" required>
                                                    </div>
                                                </div>
                                                 <div class="col-sm-3">
                                                    <div class="form-group"> 
                                                        <label>Package Groupname</label>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#form-horizontal").submit(function() {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url();?>/package/create_int_pkg_action',
                data:$("#form-horizontal").serialize(),
                success: function (data) {
                    if(data.includes('Success')){
                        toastr.success(data);
                        setTimeout(function(){ 
                            window.location.href = "<?= base_url();?>/package/internet";
                        }, 2000);
                    }else{
                        setTimeout(function(){ 

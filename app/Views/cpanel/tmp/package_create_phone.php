		...
		<div class="container-fluid">
			<div class="page-title-box">
				<div class="row align-items-center">
					<div class="col-sm-6">
						<h4 class="page-title">Package <small>Create (Phone)</small></h4>
					</div>
                    <!-- <div class="col-sm-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                 ...
                                                 <div class="col-sm-3">
                                                    <div class="form-group"> 
                                                        <label>Minutes</label>
                                                        <input name="minutes" type="number" class="form-control" required min="1">
                                                    </div>
                                                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#form-horizontal").submit(function() {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url();?>/package/create_phone_pkg_action',
                data:$("#form-horizontal").serialize(),
                success: function (data) {
                    if(data.includes('Success')){
                        toastr.success(data);
                        setTimeout(function(){ 
                            window.location.href = "<?= base_url();?>/package/phone";
                        }, 2000);
                    }else{
                        setTimeout(function(){ 

		...
		<div class="container-fluid">
			<div class="page-title-box">
				<div class="row align-items-center">
					<div class="col-sm-6">
						<h4 class="page-title">Package <small>Internet</small></h4>
					</div>
                    <div class="col-sm-6">
                        ...
                        <?php } ?>
                        <a type="button" class="btn btn-primary btn-icon" href="<?= base_url();?>/package-internet/create">
...
<script>
  ...
  //
    function user_fetchdata(){
        ...
        $.ajax({
            method: 'POST',
            url: '<?php echo base_url();?>/Package/show_list_internet',
